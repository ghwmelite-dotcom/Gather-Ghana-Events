      ...
      <section className="bg-plum-deep text-cream pt-32 pb-12">
        <Container>
          ...
          <nav aria-label="Organizer tools" className="mt-5 flex flex-wrap gap-2">
            ...
            {canWrite && <Link to="/org/services" className="text-sm rounded-full bg-cream/10 hover:bg-cream/20 text-cream px-4 py-1.5 transition-colors">Services</Link>}
            {canWrite && <Link to="/org/content" className="text-sm rounded-full bg-cream/10 hover:bg-cream/20 text-cream px-4 py-1.5 transition-colors">Content</Link>}
