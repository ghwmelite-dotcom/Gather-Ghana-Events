...
const values = [
  { title: 'Presence', desc: 'We carry the details so you can be fully in the moment with the people who matter.' },
  { title: 'Craft', desc: 'Considered design in everything, from the first mood board to the final table setting.' },
  { title: 'Warmth', desc: 'Every client is treated as our only client. Your celebration is personal to us, too.' },
]
